...
window.onload = function () {
    ...
    /* requestConfigData con javascript. REVISAR
     ...
     //xmlhttp.open("GET", "conf.json", true);// poner nombre del servlet
     xmlhttp.open("GET", "ArchivosJson", true);// poner nombre del servlet
     xmlhttp.send();
     */

//Definición de funciones ---------------------------------------------
function requestConfigData() {
    alert("function requestConfigData");
    var url = "ArchivosJson";
