...
function getPromptText() {
    ...
    for (i in docJson) {        
        var nombre = docJson[i].nombre;
        var nave = docJson[i].nave;
        var sonido = docJson[i].sonido;
        text += "\n CONFIGURACION " + nombre + "  nave:" + nave + "  sonido:" + sonido;
    }
...
function requestConfigData() {
    ...
    for (i = 0; i < docJson.length; i++) {        
        ...
        var nave = docJson[i].nave;
        var sonido = docJson[i].sonido;
        if (nombre == configuracionSolicitada) {
...
function saveConfigData(numeroNave, sound, configuracion) {
    var emess = "Error desconocido";
    alert("nave: " + numeroNave + " - sonido: " + sound + " - nombre configuracion: " + configuracion);
